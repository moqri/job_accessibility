...
L.Control.GeoSearch = L.Control.extend({
    ...
    geosearch: function (qry) {
        ...
        //calls google API to get coordinates of search 
        googleProvider.GetLocations(qry, function(data){
            onMapClick(data);
        });
    },
    ...
    sendRequest: function (provider, url, qry) {
        ...
        function getJsonP (url) {
            url = url + 'key=AIzaSyBiiV9HbdtsGwOkvweul-VlmOCKHqDlAyg&callback=parseLocation';
